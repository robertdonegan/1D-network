...
// its slot) in the Default state and only appears on Hover. The 16px glyph is
// laid out inside a 12x16 hit area like the spec's inset overlay.
  ...
  return (
    <div style={{ width: 12, height: 16, position: "relative", flexShrink: 0, opacity: show ? 1 : 0 }}>
      <div style={{ position: "absolute", inset: "0 -2px" }}>
        <Icon src={A.ellipsisVert} size={16} />
      </div>
    </div>
  );
}