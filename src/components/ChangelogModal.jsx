...
const CHANGELOG = [
  {
    ...
    items: [
      ...
      { tag: "Improved", text: "The play/pause icons in the Global Animator transport bar are now brand blue too, matching the other Flood Icons." },
      { tag: "Improved", text: "The TUFLOW editor icon in the panel switcher is now also brand blue, matching the rest of the panel icons." },
